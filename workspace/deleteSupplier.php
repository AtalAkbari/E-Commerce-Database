<!-- The following web page implements the SQL DELETE function. Tables involved: Supplier, Product, Customer, Carrier, One_order, Orders, and Payment. This webpage handles the deletion for the Supplier table -->
...
<?php      
         //Connect to Oracle       
        $conn = oci_connect("USERNAME", "PASSWORD", "(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=HOST_NUMBER)(PORT=PORT_NUM))(CONNECT_DATA=(SID=orcl)))");
...
<body>
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="deleteSupplier.php">Delete a record</a>
                </li>
            ...
            <div class="tab-content" style='margin-left:-2%'>
                ...
                <div class="tab-pane active" id="supplierDiv">
                    <form action="deleteSupplier.php" method="get">
                        ...
                        <div class="form-group">
                            ...
                            SUPPLIERID row to delete :</label> <select name=
                            "tableType">
                                <?php
                ...
                <div class="tab-pane" id="productsDiv">
                    <form action="deleteProducts.php" method="get">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4">Pick
                            PRODUCTID row to delete :</label> <select name=
                            "tableType">
                                <?php
                                                        echo  "    <option value='NULL'>NULL</option>" ;
                ...
                <div class="tab-pane" id="paymentDiv">
                    <form action="deletePayment.php" method="get">
                        <?php
                                            // SHOW PAYMENT TABLE 
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4">Pick
                            PAYMENT_ID row to delete :</label> <select name=
                            "tableType">
                                <?php
                                                        echo  "    <option value='NULL'>NULL</option>" ;
                ...
                <div class="tab-pane" id="ordersDiv">
                    <form action="deleteOrders.php" method="get">
                        <?php
                                            // SHOW ORDER TABLE 
                        ...
                        <div class="form-group">
                            ...
                            row to delete :</label> <select name="tableType">
                                <?php
                                                        echo  "    <option value='NULL'>NULL</option>" ;
                ...
                <div class="tab-pane" id="one_orderDiv">
                    <form action="deleteOne_order.php" method="get">
                        <?php
                ...
                <div class="tab-pane" id="customerDiv">
                    <form action="deleteCustomer.php" method="get">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4">Pick
                            CUSTOMER_ID row to delete :</label> <select name=
                            "tableType">
                                <?php
                                                        echo  "    <option value='NULL'>NULL</option>" ;
                ...
                <div class="tab-pane" id="carrierDiv">
                    <form action="deleteCarrier.php" method="get">
                        <?php
                                            // SHOW CARRIER TABLE 
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4">Pick
                            CARRIERID row to delete :</label> <select name=
                            "tableType">
                                <?php
                                                        echo  "    <option value='NULL'>NULL</option>" ;
    ...
    <script src="js/bootstrap.min.js">
     ...
     $query =  "DELETE FROM SUPPLIER WHERE SUPPLIERID=" . "'" . $tableType . "'";
